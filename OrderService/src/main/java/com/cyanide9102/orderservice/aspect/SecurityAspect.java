package com.cyanide9102.orderservice.aspect;
...
public class SecurityAspect {
    ...
    @Before("@annotation(com.cyanide9102.orderservice.annotation.RequiresLogin) || @within(com.cyanide9102.orderservice.annotation.RequiresLogin)")
    ...
    @Before("@annotation(com.cyanide9102.orderservice.annotation.RequiresAdmin) || @within(com.cyanide9102.orderservice.annotation.RequiresAdmin)")
